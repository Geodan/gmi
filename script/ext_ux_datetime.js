    ...
    ,onRender:function(ct, position) {
        ...
        if('below' === this.timePosition || 'bellow' === this.timePosition) {
            t = Ext.DomHelper.append(ct, {tag:'table',style:'border-collapse:collapse',children:[
                 ...
                 {tag:'tr',children:[{tag:'td', style:'padding-bottom:1px', cls:'datetime-date'}]}
                //,{tag:'tr',children:[{tag:'td', cls:'ux-datetime-time'}]}
                ,{tag:'tr',children:[{tag:'td', cls:'datetime-time'}]}
            ]}, true);
        }
        else {
            t = Ext.DomHelper.append(ct, {tag:'table',style:'border-collapse:collapse',children:[
                {tag:'tr',children:[
                    ...
                    {tag:'td',style:'padding-right:4px', cls:'datetime-date'},{tag:'td', cls:'datetime-time'}
                ]}
            ]}, true);
        }
